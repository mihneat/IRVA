...
namespace AR_ManoMotion
{
    public class HandGestureController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            ManoGestureContinuous gestureCont = gestureInfo.mano_gesture_continuous;

            /* TODO 5.3. Get the trigger gestures */
            ManoGestureTrigger gestureTrigger = gestureInfo.mano_gesture_trigger;
             ...
             */
            if (gestureCont == ManoGestureContinuous.CLOSED_HAND_GESTURE)
                _fruitSpawner.SpawnMultiplier = 20;
            else
                _fruitSpawner.SpawnMultiplier = 1;
            ...
            if (gestureTrigger == ManoGestureTrigger.PICK)
                foreach (var fruitController in FindObjectsOfType<FruitController>())
                    fruitController.DestroyFruitInstance();
        }
    }
}